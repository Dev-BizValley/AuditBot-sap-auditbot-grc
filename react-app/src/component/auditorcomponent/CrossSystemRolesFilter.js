...
const CrossSystemRolesFilter = () => {
  ...
  const onFilterSubmit = () => {
    ...
    dispatch(action.getCrossSystemRolesReport(token, filterPayload));
  };
  ...
  return (
    <Box position="relative" width="100%" style={{ minHeight: '0px', backgroundColor: 'transparent' }}>
      ...
      >
        ...
        {/* Auth Obj */}
        <Box flex="0 0 auto" width={115}>
          <LicenceTextFiled label="Auth Obj" value={authObj} onchange={(v) => setAuthObj(v)} />
        </Box>

        {/* Auth Field */}
        <Box flex="0 0 auto" width={115}>
          <LicenceTextFiled label="Auth Field" value={authField} onchange={(v) => setAuthField(v)} />
        </Box>

        {/* Auth Value */}
        <Box flex="0 0 auto" width={115}>
          <LicenceTextFiled label="Auth Value" value={authVal} onchange={(v) => setAuthVal(v)} />
        </Box>
...
export default CrossSystemRolesFilter;
